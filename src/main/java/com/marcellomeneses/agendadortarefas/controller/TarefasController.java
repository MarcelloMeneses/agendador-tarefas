package com.marcellomeneses.agendadortarefas.controller;

import com.marcellomeneses.agendadortarefas.Infrastructure.enums.StatusNotificacaoEnum;
import com.marcellomeneses.agendadortarefas.business.TarefasService;
...
public class TarefasController {
    ...
    public ResponseEntity<TarefasDTO> alteraStatusNotificacao(@RequestParam("status") StatusNotificacaoEnum status,
        ...
        return ResponseEntity.ok(tarefasService.aletaStatus(status, id));
    }
