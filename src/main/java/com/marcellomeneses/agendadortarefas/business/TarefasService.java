...
import com.marcellomeneses.agendadortarefas.Infrastructure.exceptions.ResourceNotFoundException;
...
import com.marcellomeneses.agendadortarefas.business.mapper.TarefaUpdateConverter;
...
public class TarefasService {
    ...
    public TarefasDTO aletaStatus(StatusNotificacaoEnum status, String id) {
        try {
